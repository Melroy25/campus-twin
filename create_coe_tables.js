...
const coeSchemas = {
  ...
  coeEvents: {
    ...
    title: 255,
    date: 255,
    type: 255, // holiday, exam, display, feedback
    createdAt: 255
  }
};
...
async function run() {
  console.log("Starting Calendar of Events DB setup...");

  for (const [colName, attributes] of Object.entries(coeSchemas)) {
  ...
  console.log("Calendar of Events DB Setup Complete!");
}
