...
const NAV_ITEMS = {
  student: [
    ...
    { label: 'Placement Portal', icon: <MdWork />, path: '/placement/student' },
    { label: 'Hostel Portal', icon: <MdHome />, path: '/hostel' },
  ...
  teacher: [
    ...
    { label: 'Placement Attendance', icon: <MdWork />, path: '/teacher/placement-attendance' },
